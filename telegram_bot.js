// ==========================================================
// 🛡️ FUNÇÃO EXPORTADA EXIGIDA PELO INDEX.JS
// ==========================================================
export async function processarMensagemTelegram(request, env, ctx) {
    ...
    // ==========================================================
    // 📊 API 1: /api/ranking_api (Tabela Completa para a Vercel)
    // ==========================================================
    ...
    // ==========================================================
    // 📥 FLUXO DO TELEGRAM (Roda via Webhook/POST)
    // ==========================================================
        ...
        try {
            ...
            if (texto === "suporte_bot") {
                ...
                const textosSuporte = {
                    ...
                    es: `🛠 <b>Soporte de Usuario</b>\n\n¿Necesitas ajuda o encontraste um error?\n\n👉 Contacta directamente com nuestro administrador haciendo clic en el botón de abajo o envía un message al soporte oficial.`
                };
                const botoesSuporte = {
    ...
    return new Response("Rota não reconhecida", { status: 404 });
}
